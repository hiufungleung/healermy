...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Launch Section */}
      <div className="bg-background max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
      ...
      {/* Features Section */}
      <div className="bg-background py-8 sm:py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 md:mb-8">Platform Features</h2>
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6 md:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-sm sm:text-base md:text-lg font-semibold mb-1 sm:mb-2">Real-time Scheduling</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-sm sm:text-base md:text-lg font-semibold mb-1 sm:mb-2">Secure & Compliant</h3>
              <p className="text-xs sm:text-sm text-text-secondary">
            ...
            <div className="text-center">
              ...
              <h3 className="text-sm sm:text-base md:text-lg font-semibold mb-1 sm:mb-2">Instant Notifications</h3>
              <p className="text-xs sm:text-sm text-text-secondary">
      ...
      <footer className="bg-gray-50 py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-text-secondary">
            <p className="text-xs sm:text-sm">&copy; 2025 healerMy. All rights reserved.</p>
            <p className="text-xs sm:text-sm mt-2">A SMART on FHIR Healthcare Platform</p>
          </div>
        </div>
      </footer>
    </div>
