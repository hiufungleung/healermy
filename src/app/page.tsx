    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-background max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-1 md:py-1">
        <div className="max-w-2xl mx-auto text-center">
          {/* <h2 className="text-xl sm:text-2xl sm:text-2xl sm:text-3xl font-bold mb-4 md:mb-6">Access healerMy Platform</h2>
      ...
      <div className="bg-background py-8 sm:py-10 md:py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* <h2 className="text-xl sm:text-2xl sm:text-2xl sm:text-3xl font-bold text-center mb-6 md:mb-8">Platform Features</h2> */}
