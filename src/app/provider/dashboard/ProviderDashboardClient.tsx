    ...
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-8">
        ...
        <Card className="text-center p-3 md:p-4">
          ...
          <div className="text-xl md:text-xl sm:text-2xl font-bold text-yellow-600">{appointments.pending}</div>
        ...
        <Card className="text-center p-3 md:p-4">
          ...
          <div className="text-xl md:text-xl sm:text-2xl font-bold text-purple-600">{appointments.total}</div>
