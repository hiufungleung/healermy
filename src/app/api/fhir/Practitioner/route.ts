...
import { createPractitioner } from '@/app/api/fhir/Practitioner/operations';

/**
 * GET /api/fhir/Practitioner - Search practitioners
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error in GET /api/fhir/Practitioner:', error);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in POST /api/fhir/Practitioner:', error);
