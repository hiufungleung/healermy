...
/**
 * GET /api/fhir/Slot/[id] - Get slot by ID
 */
export async function GET(
  ...
  try {
    ...
    const { id } = await params;
    console.error(`Error in GET /api/fhir/Slot/${id}:`, error);
...
/**
 * PUT /api/fhir/Slot/[id] - Update slot by ID (providers only)
 */
export async function PUT(
  ...
  try {
    ...
    const { id } = await params;
    console.error(`Error in PUT /api/fhir/Slot/${id}:`, error);
...
/**
 * PATCH /api/fhir/Slot/[id] - Partial update slot (providers only)
...
export async function PATCH(
  ...
  try {
    ...
    const { id } = await params;
    console.error(`Error in PATCH /api/fhir/Slot/${id}:`, error);
...
/**
 * DELETE /api/fhir/Slot/[id] - Delete slot by ID (providers only)
 */
export async function DELETE(
  ...
  try {
    ...
    const { id } = await params;
    console.error(`Error in DELETE /api/fhir/Slot/${id}:`, error);
