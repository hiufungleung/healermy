...
import { searchAppointments, createAppointment } from '@/app/api/fhir/Appointment/operations';
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error in GET /api/fhir/Appointment:', error);
...
/**
 * POST /api/fhir/Appointment - Create appointment
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in POST /api/fhir/Appointment:', error);
