...
/**
 * GET /api/fhir/Schedule - Search schedules
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error in GET /api/fhir/Schedule:', error);
...
/**
 * POST /api/fhir/Schedule - Create schedule
 */
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in POST /api/fhir/Schedule:', error);
