...
import { getAccount, getOrganization } from '../../Patient/operations';

/**
 * GET /api/fhir/Account/[id] - Get account with owner organization details
 */
export async function GET(
  ...
  try {
    ...
    const { id: accountId } = await params;
    console.error(`Error in GET /api/fhir/Account/${accountId}:`, error);
